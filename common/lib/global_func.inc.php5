...
function get_revenue_chart_loop()
{
  ...
  $loop[0] = '2016-candidate_in_play_bar_chart';
  $loop[1] = '2016-candidate_in_play_bar_chart';
  $loop[2] = '2017-candidate_in_play_bar_chart';
  $loop[3] = '2017-candidate_in_play_bar_chart';
  $loop[4] = '2016-candidate_in_play_bar_chart';
