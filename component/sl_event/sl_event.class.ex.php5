   ...
   $oForm->addField('input', 'date_event', array('type' => 'hidden', 'label'=>'Date', 'value' => $sDate));
    ...
    if($sEventType == 'character')// eklenmis 10 lu varsa eskisi gibi sadece tek alan gosterilecek
    {
      ...
      else
      {
        ...
        $oForm->addField('textarea', 'career_note', array('label'=>'Career History', 'value' => $oDbResult->getFieldValue('career_note'), 'isTinymce' => 1));
        ...
        $oForm->addField('textarea', 'education_note', array('label'=>'Education & Training', 'value' => $oDbResult->getFieldValue('education_note'), 'isTinymce' => 1));
        ...
        $oForm->addField('textarea', 'past_note', array('label'=>'Companies – introduced recently / bing pitched', 'value' => $oDbResult->getFieldValue('past_note'), 'isTinymce' => 1));
