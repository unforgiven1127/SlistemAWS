          ...
          <table>
            <tr>
              ...
              <td style="padding-left:40px;" >
                <a onclick="document.getElementsByClassName(\'menuActionBloc\').style.height = \'250px\';" href="javascript:;" class="expandLogo"><img style="width:15px;" src="/common/pictures/slistem/expand.ico" /></a>
              </td>
            </tr>
          </table>
