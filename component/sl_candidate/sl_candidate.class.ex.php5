...
//$oForm->addField('misc', '', array('style'=> 'text-align: center','type' => 'text', 'text' => '<a href="#" onclick="alert(`munir alert`)">Click Me</a>'));
    ...
    private function _getCandidateAddForm($pnCandidatePk = 0)
    {
      ...
      $oForm2->addField('input', 'btn', array('style'=> 'hidden','id'=> 'clickThis','type'=> 'button', 'value'=>'TEST', 'onclick' => "setLoadingScreen('body', true); setTimeout('setLoadingScreen(\\'body\\', false);', 5000); AjaxRequest('".$sURL."', '', 'addcandidateId', 'candi_duplicate');"));
