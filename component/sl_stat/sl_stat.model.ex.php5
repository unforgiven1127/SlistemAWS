...
$flag = 0;
  ...
  public function get_ccm_data($user_ids, $start_date, $end_date, $group = 'researcher')
  {
    ...
    {
      $query = 'SELECT min(m2.sl_meetingpk) as min_date,m2.meeting_done as m2_meeting_done,slm.meeting_done,slm.created_by as meeting_created_by, slp.sl_position_linkpk, slp.positionfk, slp.candidatefk, slp.created_by
