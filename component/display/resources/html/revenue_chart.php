		...
		<tr >
			<td  valign="top" >
				<table class="revenue_table">
					<tr>
						<th style="width:50%; font-size:350%; white-space: nowrap;" class="text_center" colspan="6"><?php echo ucfirst($location); ?> - Individual Revenue Consultants <?php echo $year; ?></th>
					</tr>
					<tr>
						...
						<th style="height: 50px; font-size: 250%;" class="text_center">Placed</th>
					...
					<?php if(($value['Consultant']['userPosition'] == "Consultant" || $value['userPosition'] == "Not defined")){ $total_consultant_count++;?>
						<tr class="hover_row<?php echo $even; ?>">
							...
							<td style="height: 50px; font-size: 180%;" class="text_center"><?php echo $value['Consultant']['placed']; ?></td>
					...
					<tr class="revenue_table_footer">
						<td style="height: 50px; font-size: 180%;" class="text_center" colspan="4">Total</td>
						<td style="height: 50px; font-size: 180%;" class="text_right">&yen;<?php echo number_format($total_signed, $decimals, '.', ','); ?></td>
						<td style="height: 50px; font-size: 180%;" class="text_right">&yen;<?php echo number_format($total_paid, $decimals, '.', ','); ?></td>
			...
			<table class="revenue_table">
					<tr>
						<th style="width:50%; font-size: 350%; white-space: nowrap;"  class="text_center" colspan="7"><?php echo ucfirst($location); ?> - Individual Revenue Researchers <?php echo $year; ?></th>
					</tr>
					<tr>
