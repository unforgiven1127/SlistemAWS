	...
	<table style="width:100%;" valign="top">
		<tr >
			<td style="width:50%;" valign="top" >
				<table class="revenue_table">
					...
					<tr class="revenue_table_footer">
						<td style="height: 45px; font-size: 180%;" class="text_center" colspan="4">Total</td>
						<td style="height: 45px; font-size: 180%;" class="text_right">&yen;<?php echo number_format($total_signed, $decimals, '.', ','); ?></td>
						<td style="height: 45px; font-size: 180%;" class="text_right">&yen;<?php echo number_format($total_paid, $decimals, '.', ','); ?></td>
			...
			<table class="revenue_table">
					...
					<tr class="revenue_table_footer">
						<td style="height: 45px; font-size: 180%;" class="text_center" colspan="3">Total</td>
						<td style="height: 45px; font-size: 180%;" class="text_left" colspan="4">&yen;<?php echo number_format($total_signed_researcher, $decimals, '.', ','); ?></td>
