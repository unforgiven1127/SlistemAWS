		...
		<tr>
			<td>
				<table class="revenue_table">
					...
					<tr>
						<th style="width: 100px; height: 39px; font-size: 12pt;" class="text_center">Rank</th>
						<th style="min-width: 200px; height: 39px; font-size: 12pt;" class="text_center">Name</th>
						<th style="height: 39px;" class="text_center"></th>
						<th style="height: 39px; font-size: 12pt;" class="text_center">Signed</th>
						<th style="height: 39px; font-size: 12pt;" class="text_center">Paid</th>
						<!--<th class="text_center">Team</th>-->
						<th style="width: 100px; height: 39px; font-size: 12pt;" class="text_center">Placed</th>
					</tr>
