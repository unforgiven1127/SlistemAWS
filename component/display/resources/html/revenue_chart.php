		...
		<tr >
				...
				<table class="revenue_table">
					...
					<?php if(($value['Consultant']['userPosition'] == "Consultant" || $value['userPosition'] == "Not defined")){ $total_consultant_count++;?>
						<tr class="hover_row<?php echo $even; ?>">
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $row_number_rank; ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $display_object->getPicture('/common/pictures/flags/'.$flag_pic); ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $value['Consultant']['name']; ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_right">&yen;<?php echo number_format($value['consultant']['signed'], $decimals, '.', ','); ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_right">&yen;<?php echo number_format($value['consultant']['paid'], $decimals, '.', ','); ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $value['Consultant']['placed']; ?></td>
			...
			<table class="revenue_table">
					...
					<?php if($value['Researcher']['userPosition'] == "Researcher" || $value['userPosition'] == "Not defined"){
						...
						<tr class="hover_row<?php echo $even; ?>">
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $researcher_rank; ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $display_object->getPicture('/common/pictures/flags/'.$flag_pic); ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $value['Researcher']['name']; ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_right">&yen;<?php echo number_format($value['researcher']['signed'], $decimals, '.', ','); ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $value['Researcher']['placedRevenue']; ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $value['Researcher']['mccm']; ?></td>
							<td style="height: 6%; font-size: 150%;" class="text_center"><?php echo $value['Researcher']['ccm1']; ?></td>
							<!--<td class="text_center"><?php echo $value['team']; ?></td>-->
					...
					<?php if($total_consultant_count>0)
					{
						...
						for ($i=0; $i < $total_consultant_count ; $i++) {
							...
							<tr>
								...
								<td style='height: 6%; font-size: 150%;'><center>".$empty_flag ."</center></td>
								<td style='height: 6%; font-size: 150%;'><center>-</center></td>
								<td style='height: 6%; font-size: 150%;'><center>-</center></td>
								<td style='height: 6%; font-size: 150%;'><center>-</center></td>
								<td style='height: 6%; font-size: 150%;'><center>-</center></td>
