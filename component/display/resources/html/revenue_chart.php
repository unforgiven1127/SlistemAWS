		...
		<tr >
				...
				<table class="revenue_table">
					...
					<?php if(($value['Consultant']['userPosition'] == "Consultant" || $value['userPosition'] == "Not defined")){ $total_consultant_count++;?>
						<tr class="hover_row<?php echo $even; ?>">
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $row_number_rank; ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $display_object->getPicture('/common/pictures/flags/'.$flag_pic); ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $value['Consultant']['name']; ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_right">&yen;<?php echo number_format($value['consultant']['signed'], $decimals, '.', ','); ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_right">&yen;<?php echo number_format($value['consultant']['paid'], $decimals, '.', ','); ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $value['Consultant']['placed']; ?></td>
					...
					<tr class="revenue_table_footer">
						<td style="height: 40px; font-size: 160%;" class="text_center" colspan="3">Total</td>
						<td style="height: 40px; font-size: 160%;" class="text_right">&yen;<?php echo number_format($total_signed, $decimals, '.', ','); ?></td>
						<td style="height: 40px; font-size: 160%;" class="text_right">&yen;<?php echo number_format($total_paid, $decimals, '.', ','); ?></td>
						<td style="height: 40px; font-size: 160%;" class="text_center"><?php echo $total_placed; ?></td>
					</tr>
				</table>
			</td>
			<td style="width:50%;" valign="top" >
			<table class="revenue_table">
					...
					<?php if($value['Researcher']['userPosition'] == "Researcher" || $value['userPosition'] == "Not defined"){
						...
						<tr class="hover_row<?php echo $even; ?>">
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $researcher_rank; ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $display_object->getPicture('/common/pictures/flags/'.$flag_pic); ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $value['Researcher']['name']; ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_right">&yen;<?php echo number_format($value['researcher']['signed'], $decimals, '.', ','); ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $value['Researcher']['placedRevenue']; ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $value['Researcher']['mccm']; ?></td>
							<td style="height: 10%; font-size: 160%;" class="text_center"><?php echo $value['Researcher']['ccm1']; ?></td>
							<!--<td class="text_center"><?php echo $value['team']; ?></td>-->
					...
					<tr class="revenue_table_footer">
						<td style="height: 40px; font-size: 160%;" class="text_center" colspan="3">Total</td>
						<td style="height: 40px; font-size: 160%;" class="text_right">&yen;<?php echo number_format($total_signed_researcher, $decimals, '.', ','); ?></td>
						<td style="height: 40px; font-size: 160%;" class="text_center"><?php echo $total_placed_researcher?></td>
						<td style="height: 40px; font-size: 160%;" class="text_center"><?php echo $total_mccm_researcher?></td>
						<td style="height: 40px; font-size: 160%;" class="text_center"><?php echo $total_ccm1_researcher?></td>
