		...
		<tr >
				...
				<table class="revenue_table">
					...
					<?php if(($value['Consultant']['userPosition'] == "Consultant" || $value['userPosition'] == "Not defined")){ $total_consultant_count++;?>
						<tr class="hover_row<?php echo $even; ?>">
							...
							<td style="height: 50px; font-size: 200%;" class="text_right"><?php echo $value['Consultant']['placed']; ?></td>
					...
					<tr class="revenue_table_footer">
						<td style="height: 50px; font-size: 200%;" class="text_center" colspan="4">Total</td>
			...
			<table class="revenue_table">
					...
					<?php if($value['Researcher']['userPosition'] == "Researcher" || $value['userPosition'] == "Not defined"){
						...
						<tr class="hover_row<?php echo $even; ?>">
							<td style="height: 51px; font-size: 200%;" class="text_center"><?php echo $researcher_rank; ?></td>
							<td style="height: 51px; font-size: 200%;" class="text_center"><?php echo $display_object->getPicture('/common/pictures/flags/'.$flag_pic); ?></td>
							<td style="height: 51px; font-size: 200%;" class="text_center"><?php echo $value['Researcher']['name']; ?></td>
							<td style="height: 51px; font-size: 200%;" class="text_right">&yen;<?php echo number_format($value['researcher']['signed'], $decimals, '.', ','); ?></td>
							<td style="height: 51px; font-size: 200%;" class="text_center"><?php echo $value['Researcher']['placedRevenue']; ?></td>
							<td style="height: 51px; font-size: 200%;" class="text_center"><?php echo $value['Researcher']['mccm']; ?></td>
							<td style="height: 51px; font-size: 200%;" class="text_center"><?php echo $value['Researcher']['ccm1']; ?></td>
							<!--<td class="text_center"><?php echo $value['team']; ?></td>-->
					...
					<tr class="revenue_table_footer">
						...
						<td style="height: 51px; font-size: 200%;" class="text_left" colspan="4">&yen;<?php echo number_format($total_signed_researcher, $decimals, '.', ','); ?></td>
