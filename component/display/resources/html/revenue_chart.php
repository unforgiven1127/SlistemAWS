				...
				<table class="revenue_table">
					...
					<?php if(($value['Consultant']['userPosition'] == "Consultant" || $value['userPosition'] == "Not defined")){ $total_consultant_count++;?>
						<tr class="hover_row<?php echo $even; ?>">
							...
							<td style="height: 52px; font-size: 180%;" class="text_right"><?php echo $value['Consultant']['placed']; ?></td>
					...
					<tr class="revenue_table_footer">
						<td style="height: 52px; font-size: 180%;" class="text_center" colspan="4">Total</td>
						<td style="height: 52px; font-size: 180%;" class="text_right">&yen;<?php echo number_format($total_signed, $decimals, '.', ','); ?></td>
						<td style="height: 52px; font-size: 180%;" class="text_right">&yen;<?php echo number_format($total_paid, $decimals, '.', ','); ?></td>
