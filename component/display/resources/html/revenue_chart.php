		...
		<tr >
			<td  valign="top" >
				<table class="revenue_table">
					<tr>
						<th style="width:50%; font-size:400%; white-space: nowrap; z-index: 1000;" class="text_center" colspan="5"><?php echo ucfirst($location); ?> - Individual Revenue Consultants <?php echo $year; ?></th>
					</tr>
					<tr>
