		...
		<tr >
			...
			<table class="revenue_table">
					...
					<?php if($value['Researcher']['userPosition'] == "Researcher" || $value['userPosition'] == "Not defined"){
						...
						<tr class="hover_row<?php echo $even; ?>">
							<td style="height: 52px; font-size: 180%;" class="text_center"><?php echo $researcher_rank; ?></td>
					...
					<tr class="revenue_table_footer">
						<td style="height: 52px; font-size: 180%;" class="text_center" colspan="3">Total</td>
						<td style="height: 52px; font-size: 180%;" class="text_left" colspan="4">&yen;<?php echo number_format($total_signed_researcher, $decimals, '.', ','); ?></td>
