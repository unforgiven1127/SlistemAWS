  ...
  private function _getQuickSearchForm($pbInline = false, $pasSettings = array(), $pbHidden = false)
  {
    ...
    $sHTML.= '<table style="width:105%; margin-left:-5px;">
     ...
     $sHTML.= ' /> (contains the string)</div></div>
      ...
      <div class="hidden option" style="margin-top: 15px;"><a class="floatLeft" href="javascript:;" onclick="find(\'> div:not(.option_link)\').toggle(0);">&nbsp;apply&nbsp;</a></div>


    <div class="qs_action_row">
    <a class="floatLeft" href="javascript:;" onclick="find(\'> div:not(.option_link)\').toggle(0);">&nbsp;<img src="'.self::getResourcePath().'/pictures/qs_option.png"/>&nbsp;</a>
    <a class="floatLeft" href="javascript:;" onclick="find(\'input:visible\').val(\'\').blur();">&nbsp;<img src="/component/form/resources/pictures/tree_clear.png" title="Clear quick search form" onclick="tp(this);"/>&nbsp;</a>';
