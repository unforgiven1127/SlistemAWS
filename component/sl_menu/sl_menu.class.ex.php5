...
class CSl_menuEx extends CSl_menu
{
  ...
  private function _getQuickSearchForm($pbInline = false, $pasSettings = array(), $pbHidden = false)
  {
    ...
    {
      $sHTML = $this->_oDisplay->getBlocStart('quickSearchContainer', array('class' => 'hidden', 'data-height' => 240, 'data-width' => 340, 'data-persistent' => 1, 'data-position' => '[15,85]', 'data-class' => 'noTitle','data-title' => 'Quick search...', 'data-draggable' => 0, 'data-resizable' => 0));
